...
export const ProductsDetails = () => {
    const { loading, product, error } = useSelector(state => state.productsDetails)
    const { id } = useParams();
    ...
    //Metodo para aumentar al agregar al carrito
    const increaseQty =() => {
    ...
    //Metodo para disminuir en el carrito
    const decreaseQty =() => {
        const contador = document.querySelector('.count')
    ...
    return (
        <Fragment>
            {loading ? <i class="fa fa-refresh fa-sping fa-3x fa-fw"></i> : (
                <Fragment>
                    ...
                    <div className='row d-flex justify-content-around'>
                        ...
                        <div className='col-12 col-lg-5 mt-5'>
                            ...
                            <button id="btn_review" type='button' className='btn btn-primary mt-4' data-toggle="modal" data-target="#ratingModal">Deja tu opinión</button>
                                            ...
                                            <div className="modal-content">
                                                ...
                                                <div className="modal-body">
                                                    ...
                                                    <textarea name="review"
                                                        id="review" className="form-control mt3"
                                                    ></textarea>
